...
object Level1 extends LevelT[(STuple6[FLLState], STuple3[ProcessState], STuple3[BrokenBcastState])] {

  type State = (STuple6[FLLState], STuple3[ProcessState], STuple3[BrokenBcastState])
